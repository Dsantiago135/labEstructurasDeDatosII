  ...
  */
  ...
  public:
    ...
    */
    ...
    /**
    * @brief Permite verificar si dos nodos se encuentran conectados
    * @param inicio Nodo inicial
    * @param fin Nodo final
    * @return true si los nodos se encuentran conectados
    */
    ...
    /**
    * @brief Permite Obtener el peso de una arista
    * @param inicio Nodo inicial
    * @param fin Nodo final
    ...
    */
    ...
    vector<T> vecinos(T dato) {
      ...
      // 1. Buscar la llave correspondiente al dato
      auto k = llave(dato);
      
      // 1.1 Si el dato no existe, retornar arreglo vacio
      if (k == no_existe()) {
        return v;
      }
      
      // 2. Para cada nodo conectado con k, agregar al arreglo
      for (size_t i = 0; i < conteo(); i++) {
        if (conectado(nodos[k], nodos[i])) {
          v.push_back(nodos[i]);
        }
      }
